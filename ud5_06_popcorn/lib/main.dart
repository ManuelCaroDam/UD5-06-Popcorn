...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [GestureDetector(child: const Icon(Icons.wb_sunny), onTap: () {
            setState(() {
              lightMode = !lightMode;
            });
           })],
  ...
  Future<List<Person>> fetchPeople() async {
    final response = await http.get(Uri.parse('https://api.themoviedb.org/3/movie/550?api_key=91c6fa0975d5dc7001a53ba64f3d3c92'));
